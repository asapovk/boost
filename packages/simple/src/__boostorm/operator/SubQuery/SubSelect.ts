...
import { GetNames, GetNumbers, GetObject, GetDates, GetEntit, WhereParams, GetKeyOfEnt, Order } from '../../common'
...
export type SubSelectArgs<T extends keyof EntitieTypes._Entities,
...
export type SubSelectType = <T extends keyof EntitieTypes._Entities,
    L extends keyof EntitieTypes._Entities[T]['entitie'],
    M extends keyof EntitieTypes._Entities[T]['entitie'],
    A extends { [key in keyof EntitieTypes._Entities]: EntitieTypes._Entities[key] }>
