...
import { GetNames, WhereUnsafe, OrderUnsafe, GetNumbers, GetObject, GetDates, GetEntit, WhereParams, GetKeyOfEnt, Order } from '../../common'
...
export type SubSelectUnsafeType = <Type extends object>(type: Type) =>
    <M extends keyof Type,
        A extends { [key in keyof EntitieTypes._Entities]: EntitieTypes._Entities[key] }>
